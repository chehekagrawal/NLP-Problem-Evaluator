...
# --- 2. ADVANCED CSS (Neon Synthwave Theme) ---
st.markdown("""
<style>
    /* 1. Dynamic Background - NEON SYNTHWAVE */
    .stApp {
...
if analyze_btn:
    if not desc:
        ...
        with res_c1:
            ...
            # --- COLOR LOGIC FIX ---
            # Standardize string to lowercase to match model output
            ...
            if p_class == "easy":
                ...
                bg = "#ffab00"  # Amber
                label_color = "#000000"  # Black text for contrast
            else:
                bg = "#d50000"  # Red (Hard)
                label_color = "#ffffff"
        ...
        # Pink color for chart to match theme
